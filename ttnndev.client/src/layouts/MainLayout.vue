  ...
  <div class="ims-scope min-h-screen bg-surface text-on-surface">
    ...
    <header class="fixed top-0 left-0 w-full z-[60] flex justify-between items-center px-container-padding h-16 bg-[#005EA3] border-b border-white/10 font-body-md">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="relative">
          <button class="flex items-center gap-2 cursor-pointer p-1 pr-3 rounded-full hover:bg-white/10 transition-colors"
          ...
          <div v-if="menuOpen"
            ...
            <button class="w-full text-left px-4 py-2.5 flex items-center gap-3 text-on-surface-variant hover:bg-surface-container transition-colors border-t border-outline-variant"
                    @click="askLogout">
    ...
    <div v-if="showLogoutConfirm"
      ...
      <div class="w-full max-w-[400px] bg-white rounded-2xl shadow-xl p-6">
        ...
        <div class="flex justify-end gap-3">
          <button class="px-5 py-2.5 rounded-lg font-medium text-on-surface-variant hover:bg-surface-container transition-colors"
                  @click="showLogoutConfirm = false">
            Hủy
          </button>
          <button class="px-5 py-2.5 rounded-lg font-medium text-white shadow-md transition-colors"
...
<script setup>
  ...
  const allItems = [
    ...
    { path: '/documents', label: 'Kho tài liệu', icon: 'folder_shared', roles: null },
