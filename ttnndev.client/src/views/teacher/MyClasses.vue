<template>
  <div class="ims-scope">
    <div class="flex items-center justify-between mb-6">
      ...
      <button class="text-white py-2.5 px-5 rounded-lg font-semibold flex items-center gap-2 shadow-md"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
      <div v-for="c in classes"
        ...
        <div class="flex gap-2 mt-auto pt-2">
          <button class="flex-1 px-3 py-2 rounded-lg font-medium text-body-md border border-outline-variant text-on-surface hover:bg-surface-container flex items-center justify-center gap-1"
      ...
      <div class="w-full max-w-[460px] bg-white rounded-2xl shadow-xl p-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <input v-model.number="form.soThuTuLop"
                   type="number"
                   min="1"
                   placeholder="VD: 1"
                   class="w-full px-4 py-2.5 border border-outline-variant rounded-lg text-body-md focus:border-primary outline-none" />
