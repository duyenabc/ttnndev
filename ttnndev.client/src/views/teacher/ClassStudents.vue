<template>
  <div class="ims-scope">
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <button class="px-4 py-2.5 rounded-lg font-medium text-body-md border border-outline-variant text-on-surface hover:bg-surface-container flex items-center gap-1"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
      ...
      <div class="bg-white rounded-2xl border border-outline-variant p-5">
        ...
        <div class="flex items-center gap-2 mb-1">
          <span class="px-2.5 py-1 rounded-full text-body-sm font-medium"
    ...
    <div class="bg-white rounded-2xl border border-outline-variant overflow-hidden mb-6">
      <div class="flex flex-wrap items-center gap-3 p-4 border-b border-outline-variant">
        <button class="text-white py-2 px-4 rounded-lg font-medium text-body-md flex items-center gap-1 shadow-sm"
        ...
        <button class="px-4 py-2 rounded-lg font-medium text-body-md border border-outline-variant flex items-center gap-1 disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          <tr v-for="s in students" :key="s.maGhiDanh" class="border-b border-outline-variant/60 hover:bg-surface-container/40">
            ...
            <td class="px-4 py-3">
              <div class="flex items-center justify-end gap-1">
                ...
                <button v-if="s.trangThaiThucTap !== 'DungThucTap'"
      ...
      <table v-else class="w-full text-body-md">
        ...
        <tbody>
          <tr v-for="g in groups" :key="g.maNhom" class="border-b border-outline-variant/60">
            ...
            <td class="px-4 py-3 text-on-surface-variant">{{ g.thanhVien?.length || 0 }}</td>
    ...
    <div v-if="showImport" class="fixed inset-0 z-[80] flex items-center justify-center bg-black/40 px-4" @click.self="showImport = false">
      <div class="w-full max-w-[480px] bg-white rounded-2xl shadow-xl p-6">
        ...
        <textarea v-model="importText"
                  ...
                  class="w-full px-4 py-2.5 border border-outline-variant rounded-lg text-body-md focus:border-primary outline-none font-mono"></textarea>
